...
public class Heap<E> implements Serializable{
   ...
   /**
    * When adding an element to the heap it automatically gets extended by the grow method
    */
   ...
   /**
    * returns the node at heap position pos
    */
   ...
   /**
    *Printing the content of the Heap
    *
    */
   public void print(){
